...
// CONCATENATED MODULE: ./lib/clock/actions.js
...
// CONCATENATED MODULE: ./lib/count/actions.js
var actions_actionTypes = {
  COUNT_INCREASE: 'COUNT_INCREASE',
  COUNT_DECREASE: 'COUNT_DECREASE'
};
function countIncrease() {
  return {
    type: actions_actionTypes.COUNT_INCREASE
  };
}
function countDecrease() {
  return {
    type: actions_actionTypes.COUNT_DECREASE
  };
}
...
function reducers_reducer() {
  ...
  switch (action.type) {
    case actions_actionTypes.COUNT_INCREASE:
      return state + 1;

    case actions_actionTypes.COUNT_DECREASE:
      return state - 1;
...
// CONCATENATED MODULE: ./lib/placeholder/actions.js
var placeholder_actions_actionTypes = {
  LOAD_DATA: 'LOAD_DATA',
...
function loadData() {
  return {
    type: placeholder_actions_actionTypes.LOAD_DATA
  };
}
function loadDataSuccess(data) {
  return {
    type: placeholder_actions_actionTypes.LOAD_DATA_SUCCESS,
    data: data
  };
}
function loadDataError(error) {
  return {
    type: placeholder_actions_actionTypes.LOAD_DATA_ERROR,
    error: error
  };
}
...
function placeholder_reducers_reducer() {
  ...
  switch (action.type) {
    case placeholder_actions_actionTypes.LOAD_DATA_SUCCESS:
      return Object(objectSpread["a" /* default */])({}, state, {
        data: action.data
      });

    case placeholder_actions_actionTypes.LOAD_DATA_ERROR:
      return Object(objectSpread["a" /* default */])({}, state, {
        error: action.error
      });
  ...
  return regenerator_default.a.wrap(function runClockSaga$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return Object(effects_["take"])(actionTypes.START_CLOCK);

        case 2:
          if (false) {}

          _context.next = 5;
          return Object(effects_["put"])(tickClock(false));
...
function loadDataSaga() {
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 6:
          data = _context.sent;
          _context.next = 9;
          return Object(effects_["put"])(loadDataSuccess(data));
        ...
        case 11:
          ...
          _context.next = 15;
          return Object(effects_["put"])(loadDataError(_context.t0));
  ...
  }, sagas_marked, null, [[0, 11]]);
}

/* harmony default export */ var placeholder_sagas = (Object(effects_["takeLatest"])(placeholder_actions_actionTypes.LOAD_DATA, loadDataSaga));
...
/* harmony default export */ var about = __webpack_exports__["default"] = (withReduxSaga(Object(withApollo["a" /* default */])(about_About)));
