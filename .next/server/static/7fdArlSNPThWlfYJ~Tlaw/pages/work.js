...
var Submit_createPost = external_graphql_tag_default()(_templateObject());
        ...
        return mutate({
          ...
          update: function update(proxy, _ref3) {
            ...
            var data = proxy.readQuery({
              query: PostList["a" /* allPosts */],
              variables: PostList["b" /* allPostsQueryVars */]
            });
            proxy.writeQuery({
              query: PostList["a" /* allPosts */],
...
function (_React$Component) {
  ...
  _createClass(BlogIndex, [{
    ...
    key: "render",
    value: function render() {
      return external_react_default.a.createElement(App["a" /* default */], null, external_react_default.a.createElement(Header["a" /* default */], null), external_react_default.a.createElement(PostList["c" /* default */], null), external_react_default.a.createElement(Footer["a" /* default */], null));
    }
  }]);
