...
function (_React$Component) {
  ...
  _createClass(Home, [{
    ...
    value: function render() {
      ...
      }, "Nick Hulea"), external_react_default.a.createElement("p", {
        id: "description",
        className: "jsx-1007854767"
...
/*#__PURE__*/
function (_React$Component) {
  pages_inherits(PageIndex, _React$Component);
  ...
  function PageIndex() {
    ...
    pages_classCallCheck(this, PageIndex);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = pages_possibleConstructorReturn(this, (_getPrototypeOf2 = pages_getPrototypeOf(PageIndex)).call.apply(_getPrototypeOf2, [this].concat(args)));
        ...
        return regenerator_default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                store = _ref.store;
                store.dispatch(Object(count_actions["b" /* countIncrease */])());

                if (!store.getState().placeholder.data) {
                  store.dispatch(Object(placeholder_actions["b" /* loadData */])());
                }
...
/* harmony default export */ var pages = __webpack_exports__["default"] = (Object(withReduxSaga["a" /* default */])(pages_PageIndex));
